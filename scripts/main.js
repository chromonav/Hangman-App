require(["jquery","hangman.maker","jquery.alpha"], function($) {
 ...
 $(".hangman").click(function(){location.reload();});
 $(".hangmanclass").mouseover(function(){ $(".hangman").html("new Hangman");});
 $(".hangmanclass").mouseout(function(){ $(".hangman").html("Hangman");});

 setTimeout(function(){ 
 var main = $(".mainpuzzle");
 $(".icon-arrow-left").click(function(){
											$("table").fadeOut("fastest",function(){window.close();});
